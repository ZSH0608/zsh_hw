...
export const aiModels = [
  ...
  { name: "Mixtral 8x7B", organization: "Mistral", date: d(2023, 12), parameters: 47e9, category: "Language", mmluScore: 70.6 },
  ...
  { name: "Claude 3 Haiku", organization: "Anthropic", date: d(2024, 3), parameters: 20e9, category: "Fast", mmluScore: 75.2 },
  ...
  { name: "Grok-2", organization: "xAI", date: d(2024, 8), parameters: 314e9, category: "Language", mmluScore: 87.5 },
  { name: "OpenAI o1", organization: "OpenAI", date: d(2024, 9), parameters: 1.8e12, category: "Multimodal", mmluScore: 92.3 },
  ...
  { name: "Claude 3.5 Haiku", organization: "Anthropic", date: d(2024, 10), parameters: 4e10, category: "Fast & Smart", mmluScore: 81.7 },
  ...
  { name: "o4-mini", organization: "OpenAI", date: d(2025, 3), parameters: 150e9, category: "Language", mmluScore: 89.5 },
  ...
  { name: "Llama 3 8B", organization: "Meta", date: d(2024, 4), parameters: 8e9, category: "Language", mmluScore: 68.4 }, // 小模型里程碑
  ...
  { name: "Llama 3.1 70B", organization: "Meta", date: d(2024, 7), parameters: 70e9, category: "Language", mmluScore: 86.0 }, // 性价比之王

  // Llama 3.2 Series (2024.9 - Edge & Vision)
  { name: "Llama 3.2 1B", organization: "Meta", date: d(2024, 9), parameters: 1e9, category: "Mobile/Edge", mmluScore: 49.3 }, // 手机端可用
  { name: "Llama 3.2 3B", organization: "Meta", date: d(2024, 9), parameters: 3e9, category: "Mobile/Edge", mmluScore: 63.4 }, // 惊人的小模型分数
  { name: "Llama 3.2 11B Vision", organization: "Meta", date: d(2024, 9), parameters: 11e9, category: "Multimodal", mmluScore: 73.0 }, // 视觉小模型
  ...
  { name: "Llama 3.3 70B", organization: "Meta", date: d(2024, 12), parameters: 70e9, category: "Language (Efficient)", mmluScore: 86.0 }, // 性能接近405B，但参数更少

  // --- 补充 Mistral 家族 ---

  // Mistral Early & Specialized
  { name: "Mistral Medium", organization: "Mistral", date: d(2023, 12), parameters: 70e9, category: "Language", mmluScore: 75.3 }, // API only (推测参数)
  
  // Mixtral High-End
  { name: "Mixtral 8x22B", organization: "Mistral", date: d(2024, 4), parameters: 141e9, category: "Language (MoE)", mmluScore: 77.8 }, // 巨大的MoE模型

  // Mistral New Era (2024 H2)
  { name: "Codestral 22B", organization: "Mistral", date: d(2024, 5), parameters: 22e9, category: "Coding", mmluScore: 69.0 }, // 专注于代码
  { name: "Mistral NeMo", organization: "Mistral", date: d(2024, 7), parameters: 12e9, category: "Language", mmluScore: 68.0 }, // 与NVIDIA合作，12B中的最强
  { name: "Mistral Small v3", organization: "Mistral", date: d(2024, 9), parameters: 22e9, category: "Language", mmluScore: 76.0 }, // 极具性价比
  { name: "Pixtral 12B", organization: "Mistral", date: d(2024, 9), parameters: 12e9, category: "Multimodal", mmluScore: 69.2 }, // Mistral的首个多模态
];
*/
export const aiModels = [
  // The Pre-MMLU / Early Era
